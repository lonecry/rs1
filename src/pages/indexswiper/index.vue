    ...
    <div class=" box">
        ...
        <swiper class="swiper" duration="300" :current="current_scroll" @change="change">
            <swiper-item class="swiperitem">
                ...
                <scroll-view v-if="lists" scroll-y="true" :style="computedClassObject" :upper-threshold="'350'"
                             @scrolltoupper="refresh" @scrolltolower="loadmore">
                    <!---->
                    <div class="card" :data-cardid="item.listId" :data-cardindex="index" ref="dataNum"
                         @click="cardClick($event,item.listState)" v-for="(item,index) in  lists" :key="index">
            ...
            <swiper-item class="swiperitem">
                <span v-if="refreshicon" class="freshicon"> 刷新中...<i-icon size='14' type="refresh"/></span>
                <scroll-view v-if="lists1" :scroll-y="scrolly" :style="computedClassObject" :upper-threshold="'350'"
            ...
            <swiper-item class="swiperitem">
                <span v-if="refreshicon" class="freshicon"> 刷新中...<i-icon size='14' type="refresh"/></span>
                <scroll-view   v-if="lists2" :scroll-y="scrolly" :style="computedClassObject" :upper-threshold="'350'"
            ...
            <swiper-item class="swiperitem">
                <span v-if="refreshicon" class="freshicon"> 刷新中...<i-icon size='14' type="refresh"/></span>
                <scroll-view v-if="lists3" :scroll-y="scrolly" :style="computedClassObject" :upper-threshold="'350'"
            ...
            <swiper-item class="swiperitem">
                <span v-if="refreshicon" class="freshicon"> 刷新中...<i-icon size='14' type="refresh"/></span>
                <scroll-view  v-if="lists4":scroll-y="scrolly" :style="computedClassObject" :upper-threshold="'350'"

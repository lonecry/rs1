<template>
	<div>
		...
		<div class="ipts iptbox" style="position: relative;overflow:hidden;">
			<span class="ititle">*输入病害情况描述及详细位置描述</span>
			<textarea class="reportDesc" v-model="value5" maxlength="150"  />
		</div>
		<div class="ipts">
